...
<head>
    ...
    <style>
        ...
        @media screen and (max-width: 768px) {
            ...
            td:nth-of-type(1):before { content: "ID Diagnosa:"; }
            td:nth-of-type(2):before { content: "Nama Diagnosa:"; }
            td:nth-of-type(3):before { content: "Deskripsi:"; }
            td:nth-of-type(4):before { content: "Aksi:"; } /* Tambahkan ini untuk kolom aksi */
...
<body>
    <div class="container">
        ...
        <div class="action-buttons">
            <a href="create.php" class="add-button">Tambah Diagnosa Baru</a>
        ...
        <table>
            ...
            <tbody>
                <?php
                $result = $conn->query("SELECT * FROM Diagnosa ORDER BY nama_diagnosa ASC");
                ...
                <tr>
                    ...
                    <td><?= htmlspecialchars(substr($row['deskripsi_diagnosa'], 0, 100)); ?><?= (strlen($row['deskripsi_diagnosa']) > 100) ? '...' : ''; ?></td>
                    <td class="action-links">
                        <a href="edit.php?id=<?= $row['id_diagnosa']; ?>">Edit</a>
                        <a href="delete.php?id=<?= $row['id_diagnosa']; ?>" onclick="return confirm('Yakin ingin menghapus diagnosa ini? Konsultasi yang menggunakan diagnosa ini akan kehilangan referensinya.')">Hapus</a>
                    </td>
                </tr>
                <?php
                    endwhile;
                } else {
                    echo "<tr><td colspan='4' style='text-align: center;'>Tidak ada data diagnosa.</td></tr>";
                }
                ?>
            </tbody>
        </table>
