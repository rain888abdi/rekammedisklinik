...
<head>
    ...
    <style>
        ...
        @media screen and (max-width: 768px) {
            ...
            td:nth-of-type(1):before { content: "ID Jadwal:"; }
            td:nth-of-type(2):before { content: "Dokter:"; }
            td:nth-of-type(3):before { content: "Hari:"; }
            td:nth-of-type(4):before { content: "Jam Mulai:"; }
            td:nth-of-type(5):before { content: "Jam Selesai:"; }
            td:nth-of-type(6):before { content: "Aksi:"; } /* Tambahkan ini untuk kolom aksi */
...
<body>
    <div class="container">
        ...
        <div class="action-buttons">
            <a href="create.php" class="add-button">Tambah Jadwal Baru</a>
            ...
            <tbody>
                ...
                $result = $conn->query("
                    ...
                    FROM 
                        Jadwal AS J
                    JOIN 
                        Dokter AS D ON J.id_dokter = D.id_dokter
                ...
                <tr>
                    ...
                    <td class="action-links">
                        <a href="edit.php?id=<?= $row['id_jadwal']; ?>">Edit</a>
                        <a href="delete.php?id=<?= $row['id_jadwal']; ?>" onclick="return confirm('Yakin ingin menghapus jadwal ini?')">Hapus</a>
                    </td>
                </tr>
                <?php
                    endwhile;
                } else {
                    echo "<tr><td colspan='6' style='text-align: center;'>Tidak ada data jadwal dokter.</td></tr>";
                }
                ?>
            </tbody>
        </table>
