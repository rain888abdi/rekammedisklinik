...
<head>
    ...
    <style>
        ...
        .container {
            width: 95%;
            max-width: 900px; /* Lebar maksimal disesuaikan untuk tabel */
        ...
        @media screen and (max-width: 768px) {
            ...
            td:nth-of-type(1):before { content: "ID Dokter:"; }
            td:nth-of-type(2):before { content: "Nama Dokter:"; }
            td:nth-of-type(3):before { content: "Spesialisasi:"; }
            td:nth-of-type(4):before { content: "Telepon:"; }
...
<body>
    <div class="container">
        ...
        <div class="action-buttons">
            <a href="create.php" class="add-button">Tambah Dokter Baru</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action-links">
                        ...
                        <a href="delete.php?id=<?= $row['id_dokter']; ?>" onclick="return confirm('Yakin ingin menghapus dokter ini? Semua data konsultasi terkait juga akan terpengaruh.')">Hapus</a>
                    </td>
                </tr>
                <?php
                    endwhile;
